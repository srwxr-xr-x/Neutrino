...
public class MiscEntityRegistry {
    public static void init() {
        ...
        BiomeModifications.addSpawn(BiomeSelectors.categories(OverworldBiomeCreator.createSoulSandValley().getCategory()), SpawnGroup.MONSTER, com.frostwizard4.Neutrino.entity.EntityRegistry.WITHERLING, 1, 1, 1);
