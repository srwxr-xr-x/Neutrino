...
public class NeutrinoMain implements ModInitializer {
    ...
    */ //TODO Fix to be only Client side
    ...
    /*
    public void checkIfClient(World world) {
        if(world.isClient()) {
    ...
    public static final ConfiguredFeature<?, ?> DUST_CAVES_VEGETATION = register("dust_caves_vegetation", DUST_PATCH.decorate(Decorator.CAVE_SURFACE.configure(new CaveSurfaceDecoratorConfig(VerticalSurfaceType.FLOOR, 12)).range(NeutrinoMain.BOTTOM_TO_60)).spreadHorizontally()).repeat(40);
