...
public class SoundRegister {
    ...
    public static final Identifier SERPENT_RATTLE_ID = new Identifier("neutrino:serpent_rattle");
    public static SoundEvent SERPENT_RATTLE = new SoundEvent(SERPENT_RATTLE_ID);
