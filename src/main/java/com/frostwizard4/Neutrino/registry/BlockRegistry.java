...
public class BlockRegistry {
    ...
    public static final CraftingSlab CRAFTING_SLAB = new CraftingSlab(FabricBlockSettings.of(Material.WOOD).strength(1.5f, 1.5f).sounds(BlockSoundGroup.WOOD));

    public static final Block HALF_FULL_BOOKSHELF = new Block(FabricBlockSettings.of(Material.WOOD).strength(1.5F, 1.5F).sounds(BlockSoundGroup.WOOD));
    ...
    public static final Block SWORD_SHRINE = new SwordShrine(FabricBlockSettings.of(Material.STONE).strength(1.5F, 0.8F).nonOpaque());
    public static final Block SHATTERED_SWORD_SHRINE = new ShatteredSwordShrine(FabricBlockSettings.of(Material.STONE).strength(1.5F, 0.8F).nonOpaque());
    ...
    public static final ScarecrowBlock SCARECROW = new ScarecrowBlock(FabricBlockSettings.of(Material.WOOD).strength(1.5F, 1.5F).sounds(BlockSoundGroup.WOOD).nonOpaque());
    public static final Block ALPACA_COLLECTIBLE = new AlpacaBlock(FabricBlockSettings.of(Material.WOOL).strength(0.5F, 0.5F).nonOpaque());
    public static final Block BONSAI_TREE = new BonsaiBlock(FabricBlockSettings.of(Material.WOOD).strength(0.5F, 0.5F).nonOpaque());
    public static final Block TANZANITE = new TanzaniteOre(FabricBlockSettings.of(Material.STONE).strength(3F, 6.0F).sounds(BlockSoundGroup.STONE).requiresTool());
    public static final Block ALARM_BLOCK = new AlarmClock(FabricBlockSettings.of(Material.WOOD).strength(1.5F, 1.5F).sounds(BlockSoundGroup.WOOD));
